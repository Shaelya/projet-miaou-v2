 ...
 */
final class Version20191006165742 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE advert (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, type_id INT NOT NULL, status_id INT NOT NULL, name VARCHAR(80) NOT NULL, description VARCHAR(255) NOT NULL, latitude VARCHAR(255) NOT NULL, longitude VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, age VARCHAR(10) NOT NULL, male TINYINT(1) NOT NULL, female TINYINT(1) NOT NULL, INDEX IDX_54F1F40BA76ED395 (user_id), INDEX IDX_54F1F40BC54C8C93 (type_id), INDEX IDX_54F1F40B6BF700BD (status_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE type (id INT AUTO_INCREMENT NOT NULL, species VARCHAR(80) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
